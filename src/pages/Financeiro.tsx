...
export default function Financeiro() {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-primary tracking-tight">Página de Financeiro</h1>
      <p className="text-muted-foreground text-lg">Gestão de Transações DRE e Fluxo de Caixa.</p>
