...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        'border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted max-md:block max-md:border max-md:border-border max-md:rounded-lg max-md:mb-4 max-md:p-4 max-md:bg-card max-md:shadow-sm',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 max-md:block max-md:w-full',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'p-4 align-middle [&:has([role=checkbox])]:pr-0 max-md:block max-md:p-2 max-md:text-left max-md:border-b max-md:last:border-0 max-md:w-full',
      className,
    )}
    {...props}
  />
