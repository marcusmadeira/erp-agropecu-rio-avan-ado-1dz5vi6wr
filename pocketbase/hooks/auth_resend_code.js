      ...
      try {
        $http.send({
          ...
          body: JSON.stringify({
            ...
            to: user.get('email'),
            subject: 'Seu novo código de verificação Toriba Agropecuária',
            html: `
              <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
                <h2 style="color: #094016; text-align: center;">Toriba Agropecuária</h2>
                <p>Olá ${user.get('name') || ''},</p>
                <p>Você solicitou um novo código de verificação. Utilize o código abaixo para ativar sua conta:</p>
